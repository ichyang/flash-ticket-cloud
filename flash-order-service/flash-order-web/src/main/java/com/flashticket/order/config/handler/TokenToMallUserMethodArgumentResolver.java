 ...
 * 版权所有，侵权必究！
 */
package com.flashticket.order.config.handler;
...
import com.flashticket.user.dto.MallUserDTO;
import com.flashticket.user.openfeign.FlashTicketUserServiceFeign;
...
public class TokenToMallUserMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    @Autowired
    private FlashTicketUserServiceFeign newBeeCloudUserService;
