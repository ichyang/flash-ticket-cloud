...
import com.flashticket.order.config.annotation.TokenToAdminUser;
import com.flashticket.order.controller.param.BatchIdParam;
import com.flashticket.order.controller.vo.FlashTicketOrderDetailVO;
import com.flashticket.order.entity.LoginAdminUser;
...
public class FlashTicketAdminOrderController {

    private static final Logger logger = LoggerFactory.getLogger(FlashTicketAdminOrderController.class);
    ...
    public Result list(@RequestParam(required = false) @ApiParam(value = "页码") Integer pageNumber,
        ...
        return ResultGenerator.genSuccessResult(newBeeMallOrderService.getFlashTicketOrdersPage(pageUtil));
    }

    @GetMapping("/detail/{orderId}")
    @ApiOperation(value = "订单详情接口", notes = "传参为订单号")
    public Result<FlashTicketOrderDetailVO> orderDetailPage(@ApiParam(value = "订单号") @PathVariable("orderId") Long orderId, @TokenToAdminUser LoginAdminUser adminUser) {
        logger.info("adminUser:{}", adminUser.toString());
