...
import com.flashticket.order.controller.param.SaveOrderParam;
...
public class FlashTicketOrderController {

    @Resource
    private FlashTicketOrderService newBeeMallOrderService;
    @Resource
    private FlashTicketUserAddressService newBeeMallUserAddressService;
    ...
    public Result<FlashTicketOrderDetailVO> orderDetailPage(@ApiParam(value = "订单号") @PathVariable("orderNo") String orderNo, @TokenToMallUser MallUserToken loginMallUserToken) {
    ...
    public Result<PageResult<List<FlashTicketOrderListVO>>> orderList(@ApiParam(value = "页码") @RequestParam(required = false) Integer pageNumber,
