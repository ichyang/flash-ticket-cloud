...
import com.flashticket.order.dao.FlashTicketUserAddressMapper;
...
@Service
public class FlashTicketUserAddressServiceImpl implements FlashTicketUserAddressService {

    @Autowired
    private FlashTicketUserAddressMapper userAddressMapper;

    @Override
    public List<FlashTicketUserAddressVO> getMyAddresses(Long userId) {
        List<MallUserAddress> myAddressList = userAddressMapper.findMyAddressList(userId);
        List<FlashTicketUserAddressVO> newBeeMallUserAddressVOS = BeanUtil.copyList(myAddressList, FlashTicketUserAddressVO.class);
