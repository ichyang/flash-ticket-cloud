...
import com.flashticket.ticket.controller.param.GoodsCategoryAddParam;
import com.flashticket.ticket.controller.param.GoodsCategoryEditParam;
...
public class FlashTicketAdminCategoryController {

    private static final Logger logger = LoggerFactory.getLogger(FlashTicketAdminCategoryController.class);
