...
import com.flashticket.ticket.controller.vo.FlashTicketIndexCategoryVO;
import com.flashticket.ticket.controller.vo.SecondLevelCategoryVO;
import com.flashticket.ticket.controller.vo.ThirdLevelCategoryVO;
...
@Service
public class FlashTicketCategoryServiceImpl implements FlashTicketCategoryService {
    ...
    @Override
    public List<FlashTicketIndexCategoryVO> getCategoriesForIndex() {
        List<FlashTicketIndexCategoryVO> newBeeMallIndexCategoryVOS = new ArrayList<>();
        //获取一级分类的固定数量的数据
                ...
                if (!CollectionUtils.isEmpty(thirdLevelCategories)) {
                    ...
                    if (!CollectionUtils.isEmpty(secondLevelCategoryVOS)) {
                        ...
                        for (GoodsCategory firstCategory : firstLevelCategories) {
                            FlashTicketIndexCategoryVO newBeeMallIndexCategoryVO = new FlashTicketIndexCategoryVO();
