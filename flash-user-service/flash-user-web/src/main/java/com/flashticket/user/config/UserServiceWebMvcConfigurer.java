...
import com.flashticket.user.config.handler.TokenToAdminUserMethodArgumentResolver;
import com.flashticket.user.config.handler.TokenToMallUserMethodArgumentResolver;
